...
## BMI Formulas
weight = streamlit.number_input(label="Body Weight", min_value=10.0, max_value=250.0, step=.1)
height = streamlit.number_input(label="Body Height", min_value=10.0, max_value=250.0, step=.1)
